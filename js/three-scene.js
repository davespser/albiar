...
Ammo().then((AmmoLib) => {
    // Inicializar físicas y demás código que depende de Ammo
    initPhysics();

    // Aquí va el resto del código que depende de Ammo.js
    console.log("Ammo.js inicializado", AmmoLib);

    // Tu código que usa Ammo.js
    ...
    function updatePhysics(deltaTime) {
        ...
        if (cube && cubeBody) {
            const motionState = cubeBody.getMotion[43dcd9a7-70db-4a1f-b0ae-981daa162054](https://github.com/nimigolf/nimigolf.github.io/tree/23fbb4aa8c4201fffa39c0baab639717275b0063/script3000.js?citationMarker=43dcd9a7-70db-4a1f-b0ae-981daa162054 "1")
